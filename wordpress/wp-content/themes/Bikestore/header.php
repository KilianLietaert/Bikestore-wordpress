...
<head>
    ...
    <script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/c87ba7069454f272d0b85c6b8/fc03d30968d0a39497b249fa7.js");</script>
                ...
                <div class="row top-nav">
                    ...
                    <div class="c-toplist col-xl-4 col-lg-5 col-md-6 order-xl-3 order-lg-3 order-md-3 order-sm-2 order-2">
                        <ul class="c-topnavigation">
                            ...
                            if (array_key_exists('top-menu', $locations)) {
                                ...
                                foreach ($menu_items as $item) {
                                    if (home_url($wp->request) . '/' == $item->url) {
                                        ...
                                        echo '<li class="c-topnavigation__line"><a href="' . $item->url . '">' . $item->title . '</a></li>';
                                    }
                                }
                            } else {
                            ...
                            <li><a href="<?php echo get_url_by_slug( "winkelmand" ) ?>"><svg class="c-svgnav" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <?php global $woocommerce;echo $woocommerce->cart->get_cart_contents_count();?> items</a></li>
